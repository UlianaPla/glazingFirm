...
var forms = function forms() {
  ...
  var message = {
    loading: "Загрузка",
    success: "Спасибо! Скоро с вами сважутся",
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener("click", function (e) {
    var target = e.target;
    var tabSelectorClass = tabSelector.replace(/\./, "");

    if (target && (target.classList.contains(tabSelectorClass) || target.parentNode.classList.contains(tabSelectorClass))) {
